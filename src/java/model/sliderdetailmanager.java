 ...
 * @author truon
 */
public class sliderdetailmanager {
    ...
    public sliderdetailmanager() {
    }

    public sliderdetailmanager(int slider_id, String image_link, String slider_title, boolean slider_status, String notes) {
